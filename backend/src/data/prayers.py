"""
Klasyczne modlitwy chrześcijańskie
"""
...
CLASSIC_PRAYERS = {
    "our_father": {
        ...
        "text": {
            ...
            "es": "Padre nuestro que estás en los cielos, santificado sea tu Nombre; venga tu reino; hágase tu voluntad, así en la tierra como en el cielo. Danos hoy el pan nuestro de cada día; y perdona nuestras deudas, así como nosotros perdonamos a nuestros deudores; y no nos dejes caer en tentación, mas líbranos del mal. Amén."
        },
